...
const TableComponent = ({ table }) => {
  ...
  const backgroundColor = closed ? "#B4463C" : isActive ? "#2563EB" : "#64748B";
  const chairColor      = closed ? "#FCA5A5" : isActive ? "#93C5FD" : "#94A3B8";
...
const Table_4 = ({ table }) => <TableComponent table={table} />;
