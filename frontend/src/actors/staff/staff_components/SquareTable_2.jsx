...
const ChairLeft = () => (
  <Stack direction="row" alignItems="center" spacing="3px">
    <Box sx={{ width: 8, height: 38, backgroundColor: chairColor, borderRadius: "5px" }} />
    <Box sx={{ width: 34, height: 44, backgroundColor: chairColor, borderRadius: "6px" }} />
  </Stack>
);
...
const SquareTable_8 = ({ table = { tableNumber: 1, people: "3 người", dishes: "Món đã ra: 5/7" } }) => {
  return (
